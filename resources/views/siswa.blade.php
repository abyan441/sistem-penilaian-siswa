...
<section id="data-siswa" class="siswa-content" aria-labelledby="siswa-page-title">
    ...
    <section class="siswa-search-card" aria-label="Pencarian siswa">
            ...
            <div class="siswa-table" role="table" aria-label="Data siswa">
                ...
                <div class="siswa-table-body" role="rowgroup">
                    @forelse ($siswa as $index => $item)
                        <div class="siswa-table-row" data-siswa-id="{{ $item->id }}" data-kelas-id="{{ $item->kelas_id }}" role="row">
                            ...
                            <div class="siswa-actions" role="cell">
                                <button class="edit-btn" type="button" aria-label="Edit {{ $item->nama_siswa }}">
                                    <svg viewBox="0 0 24 24" aria-hidden="true">
                                        <path d="M4 20h4l10.5-10.5a2.12 2.12 0 0 0-3-3L5 17v3z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" />
                                ...
                                <button class="delete-btn" type="button" aria-label="Hapus {{ $item->nama_siswa }}">
                                    <svg viewBox="0 0 24 24" aria-hidden="true">
                                        <path d="M5 7h14M9 7V4h6v3M8 10v8M12 10v8M16 10v8M6 7l1 14h10l1-14" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                                    </svg>
                                </button>
                            </div>
                        </div>
                    @empty
                        <div class="siswa-table-row" role="row">
                            <div class="cell-no" role="cell">-</div>
                            <div class="cell-nisn" role="cell">-</div>
                            <div class="cell-nama" role="cell">Belum ada data siswa.</div>
...
<div class="siswa-modal" id="siswa-modal" hidden>
    ...
    <section class="siswa-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="siswa-modal-title">
        <div class="siswa-modal-header">
            ...
            <button class="siswa-modal-close" id="siswa-modal-close" type="button" aria-label="Tutup modal">
                <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <form class="siswa-form" id="siswa-form">
            <div class="siswa-form-group">
                ...
                <small class="siswa-form-help">NISN harus unik dan sesuai data siswa.</small>
            </div>
            ...
            <div class="siswa-form-group">
                ...
                <div class="siswa-select-wrap">
                    <select id="siswa-jk" name="jenisKelamin" required>
            ...
            <div class="siswa-form-group">
                ...
                <div class="siswa-select-wrap">
                    <select id="siswa-tahun" name="tahunAjaran">
                        ...
                        @foreach ($kelas->pluck('tahun_ajaran')->unique()->sort()->values() as $tahun)
                ...
                <div class="siswa-select-wrap">
                    <select id="siswa-kelas" name="kelasId" required>
                        ...
                        @foreach ($kelas as $itemKelas)
                            <option value="{{ $itemKelas->id }}" data-tahun="{{ $itemKelas->tahun_ajaran }}">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function rebuildKelas(selectedValue = '') {
        ...
        if (filtered.some(option => option.value === String(selectedValue))) {
    ...
    kelasSelect.addEventListener('change', function () {
        ...
        if (selected && tahunSelect.value !== selected.tahun) {
