...
<form class="nilai-page" id="grade-form">
    ...
    <section
        ...
        aria-label="Informasi dan filter nilai"
    >
            ...
            <div class="nilai-info-grid">
                    ...
                    <label class="nilai-filter-item">
                        ...
                        >
                            ...
                            @foreach ($kelasOptions as $item)
                                <option
                                    value="{{ $item->id }}"
                                    data-tahun-ajaran="{{ $item->tahun_ajaran }}"
                                >
                ...
                @else
                    <div class="nilai-info-item">
                        ...
                        <div class="nilai-info-value" aria-label="Kelas">
...
<script>
    /*
     * Admin menggunakan input-nilai.js yang sama, tetapi request data
     * perlu membawa kelas dan tahun ajaran yang dipilih.
     *
     * Wrapper ini tidak mengubah perilaku guru dan tidak memberi admin
     * akses untuk menyimpan nilai.
     */
    document.addEventListener('DOMContentLoaded', function () {
        ...
        kelasSelect.addEventListener('change', syncYearFromClass);

        /*
         * Intercept fetch agar JS lama tetap dapat digunakan.
         * Hanya URL data nilai yang diberi parameter tambahan.
         */
        ...
        /*
         * Perubahan kelas/tahun harus memuat ulang data yang sedang dipilih.
         * Event change tambahan dipasang setelah JS utama selesai memasang
         * listener-nya.
         */
        ...
        tahunSelect.addEventListener('change', triggerDataReload);
    });
</script>
@endif
