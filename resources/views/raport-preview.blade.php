...
@push('styles')
    ...
    <style>
        ...
        .report-preview-page .print-toolbar {
            width: 100%;
            box-sizing: border-box;
        }
        ...
        <article class="report-paper" id="report-paper">
            ...
            <section class="report-section score-section">
                    ...
                    <table class="score-table">
                        <thead>
                            <tr>
                                ...
                                <th class="predicate-column">Predikat</th>
                        ...
                        <tbody>
                            @forelse ($nilai as $index => $item)
                                @php
                                    ...
                                    $deskripsi = ['A' => 'Sangat Baik', 'B' => 'Baik', 'C' => 'Cukup', 'D' => 'Kurang'][$predikat];
                                @endphp
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5">Belum terdapat nilai untuk siswa ini pada semester yang dipilih.</td>
                                </tr>
                            @endforelse
                ...
                <div class="predicate-box">
                    ...
                    <div class="predicate-list">
                        <span>A = 90 - 100 (Sangat Baik)</span>
                        <span>B = 80 - 89 (Baik)</span>
                        <span>C = 70 - 79 (Cukup)</span>
                        <span>D &lt; 70 (Kurang)</span>
                    </div>
                </div>
            </section>
            ...
            <section class="report-section note-section">
                ...
                <div class="teacher-note">
                    {{ $waliKelas ? 'Raport siswa telah diperiksa oleh wali kelas.' : 'Belum ada wali kelas yang terdaftar untuk kelas ini.' }}
                </div>
            </section>

            <section class="signature-section">
                <div class="signature-column">
                    <p class="signature-title">Orang Tua/Wali</p>
                    <div class="signature-space"></div>
                    <p class="signature-line signature-parent-line">(____________________)</p>
                </div>
                <div class="signature-column">
                    <p class="signature-title">Wali Kelas</p>
                    <div class="signature-space"></div>
                    <p class="signature-line signature-name">{{ $waliKelas?->nama_lengkap ?? '-' }}</p>
                </div>
                <div class="signature-column">
                    <p class="signature-title">Kepala Sekolah</p>
                    <div class="signature-space"></div>
                    <p class="signature-line signature-name">{{ $kepalaSekolah?->nama_lengkap ?? '-' }}</p>
                    <p class="signature-nip">{{ $kepalaSekolah?->nip ? 'NIP. '.$kepalaSekolah->nip : '' }}</p>
                </div>
            </section>
        </article>
    </div>
