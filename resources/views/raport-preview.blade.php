        ...
        <article class="report-paper" id="report-paper">
            ...
            <section class="report-section">
                ...
                <div class="identity-grid">
                    <div class="identity-column">
                        ...
                        <div class="identity-row">
                            <span>Semester</span>
                            <strong>{{ $semester == 1 ? '1 (Ganjil)' : '2 (Genap)' }}</strong>
                        </div>
                    </div>
                    ...
                    <table class="score-table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5">
                                        Belum terdapat nilai untuk siswa ini pada semester yang dipilih.
                                    </td>
                                </tr>
                            @endforelse
            ...
            <section class="report-section note-section">
                ...
                <div class="teacher-note">
                    {{ $waliKelas
                        ? 'Raport siswa telah diperiksa oleh wali kelas.'
                        : 'Belum ada wali kelas yang terdaftar untuk kelas ini.' }}
                </div>
            </section>
            ...
            <section class="signature-section">
                ...
                <div class="signature-column">
                    ...
                    <p class="signature-nip">
                        {{ $kepalaSekolah?->nip ? 'NIP. '.$kepalaSekolah->nip : '' }}
                    </p>
                </div>
            </section>
        </article>
