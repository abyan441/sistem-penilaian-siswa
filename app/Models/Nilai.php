...
class Nilai extends \Illuminate\Database\Eloquent\Model
{
    ...
    public static function validasiNilai($nilai, $namaNilai): float
    {
        if (!is_numeric($nilai) || $nilai < 0 || $nilai > 100) {
            throw new InvalidArgumentException("{$namaNilai} harus berada di antara 0 sampai 100.");
        }
    ...
    public static function dataNilaiAdmin($kelasId, $tahunAjaran, $semester, $mapelId): array
    {
        ...
        if ($tahunAjaran && $kelas->tahun_ajaran !== $tahunAjaran) {
            throw new InvalidArgumentException('Kelas dan tahun ajaran yang dipilih tidak ditemukan.');
        }
